...
1. **שם הקהל / המשרד בעברית** - למשל: `משרד האנרגיה והתשתיות`, `מגזר הציבורי`, `רשות המיסים`. **חשוב:** אל תכלול את ה־"ל" המקדימה - התבנית מוסיפה אותה אוטומטית ("בינה מלאכותית ל**AUDIENCE**"). אם הקהל הוא "רשות המיסים" אז התוצאה תהיה "בינה מלאכותית לרשות המיסים".
...
5. **תיאור לגלריה** - תיאור 1–2 משפטים. הצע ברירת מחדל: "סיכום סדנה מעשית עבור **AUDIENCE**. שילוב בינה מלאכותית בעבודה היומיומית של ארגון."
...
- **התבנית סטטית** - אג'נדת הסדנה, רשימת הכלים, כלי Vibe Coding, ולינק ה־WhatsApp זהים בכל קובצי רייכמן. אם תוכן הסדנה השתנה (כלי חדש נוסף, סקציה הוסרה) - זה לא תיקון נקודתי לקובץ אחד אלא **עדכון התבנית** ב־`.Codex/skills/new-reichman-summary/template.html`.
- **לסיכומי לא־רייכמן** - השתמש בהפניה הידנית מ־[AGENTS.md](AGENTS.md) ל־`meeting-summary/ariel-university.html`. הסקיל הזה לא מתאים לסדנאות באוניברסיטאות אחרות.
